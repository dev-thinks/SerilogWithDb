    ...
    public class CallerEnricher : ILogEventEnricher
    {
        public void Enrich(LogEvent logEvent, ILogEventPropertyFactory propertyFactory)
        {
            ...
            while (true)
            {
                ...
                if (!stack.HasMethod())
                {
                    logEvent.AddPropertyIfAbsent(new LogEventProperty("CallerName", new ScalarValue("<unknown method>")));
                    return;
                }
                ...
                if (method.DeclaringType.Assembly != typeof(Log).Assembly)
                {
                    ...
                    logEvent.AddPropertyIfAbsent(new LogEventProperty("CallerName", new ScalarValue(caller)));
                    return;
                }
